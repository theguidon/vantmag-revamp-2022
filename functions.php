...
function vant_register_styles() {
  ...
  wp_enqueue_style('styles-tag', get_template_directory_uri() . '/assets/css/tag.css', array(), $version);
...
add_filter('nav_menu_css_class', 'vant_active_nav_class', 10 , 2);

function vant_active_nav_class($classes, $item) {
